package com.tconrado.bootcampDIO.controller;
...
public class JediController {
    ...
    @PostMapping("/jedi")
    public String createJedi(@Valid @ModelAttribute Jedi jedi, BindingResult result, RedirectAttributes redirect, Model model) {
